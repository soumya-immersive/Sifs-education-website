...
export default function ImageGalleryPage() {
    ...
    const fetchEvents = async (page: number) => {
        try {
            ...
            if (!result.success && (result.message === "Gallery section is disabled" || result.message?.includes("disabled"))) {
    ...
    return (
        <div className="w-full relative mb-24 bg-[#FBFCFF]">
            ...
            <PageBanner
                title="Image Gallery"
                subtitle="Photo Highlights of Forensic Science Events"
            ...
            {!isPageEnabled ? (
                <div className="max-w-7xl mx-auto px-4 py-12">
                    ...
                    >
                        ...
                        <p className="text-gray-600">Please check back later for photo highlights of our events.</p>
                    </motion.div>
                </div>
            ) : error ? (
                <div className="max-w-7xl mx-auto px-4 py-12">
