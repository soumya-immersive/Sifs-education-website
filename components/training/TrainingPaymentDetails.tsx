...
export default function TrainingPaymentDetails({ training }: Props) {
  return (
    <motion.div
    ...
    >
      ...
      <motion.h3
        ...
        className="text-md font-bold text-[#4559ED] mb-6 uppercase tracking-wider"
      >
      ...
      <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-700">
        ...
        >
          <p className="text-xs text-gray-500 mb-4 font-medium uppercase tracking-tighter">Scan to Pay using UPI</p>
          <img
            src="/course/qr.png"
            alt="Payment QR Code"
          ...
          <p className="mt-4 text-[10px] text-center text-gray-400 max-w-[200px]">
            Please share the transaction screenshot at info@sifsindia.com after successful payment for the {training.title}.
          </p>
        </motion.div>
