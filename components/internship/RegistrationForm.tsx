        ...
        <div className="relative">
            ...
            {type === "tel" ? (
                <PhoneInputAdapter
                    ...
                    className="w-full !pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-gray-50 focus:bg-white placeholder-gray-400 text-gray-800"
                />
            ) : (
                <input
                    type={type}
                    ...
                    required={required}
                    placeholder={placeholder}
                    className="w-full pl-10 pr-4 py-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-gray-50 focus:bg-white placeholder-gray-400 text-gray-800"
                    value={value}
                    onChange={onChange}
                />
            )}
